...
describe("query-payments tool", () => {
  ...
  it("should handle mocked fetch response in queryPaymentsByDateWithWorldpayHandler", async () => {
    ...
    const result = await queryPayments.queryPaymentsByDateWithWorldpayHandler(
      dummyParams
    );
